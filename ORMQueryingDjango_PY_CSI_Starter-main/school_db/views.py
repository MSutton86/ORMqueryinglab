...
def problem_one(request):
  ...
  ordered_students = students.order_by('-gpa')
...
def problem_two(request):
  ...
  ordered_instructors = instructors.order_by('hire_date')
...
def problem_five(request):
  new_student = Student.objects.create(first_name="Kyle", last_name="Hardwood", year=9, gpa=3.0)
